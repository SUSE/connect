Feature: SUSEConnect full stack integration testing
  ...
  This means we have to register a test machine againsta production server and examine all relevant data

  Scenario: Successful system registration
    And I register a system with regcode 'E9DB3A42DF2288'
